...
- [X] Explain what a token is used for.
   ...
   Token is a string of cryptic text, stored in the client (local storage) and used by the server to determine the service permissions for the user.

- [X] What steps can you take in your web apps to keep your data secure?

  It requires logins and issues specific tokens, also needs to use private routes.

- [X] Describe how web servers work.

'Web server' can mean two things , the physical device that stores the website codes and the program that such devices run in order to host the websites.ver.
